...
parser.add_argument('--audiopath', type=str, default='/root/FACIAL/examples/audio_preprocessed/train1.pkl')
parser.add_argument('--npzpath', type=str, default='/root/FACIAL/video_preprocess/train1_posenew.npz')
parser.add_argument('--cvspath', type=str, default = '/root/FACIAL/video_preprocess/train1_openface/train1_512_audio.csv')
parser.add_argument('--pretainpath_gen', type=str, default = '/root/FACIAL/audio2face/checkpoint/obama/Gen-20-0.0006273046686902202.mdl')
